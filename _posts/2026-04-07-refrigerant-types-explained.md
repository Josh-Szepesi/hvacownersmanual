---
layout: post
title: "Refrigerant Types Explained: R-22, R-410A, and R-32"
description: "R-22, R-410A, and R-32 use different pressures and environmental impacts. Here's how to identify your system's refrigerant and what the phase-out means for you."
date: 2026-04-07
image: /assets/images/2026-04-07-refrigerant-types-explained.jpg
---
...
![Outdoor air conditioning unit mounted on a wall of a residential building](/assets/images/2026-04-07-refrigerant-types-explained.jpg)
...
1. **Continue repairing it** as long as the system holds charge and repairs remain cost-effective. This works if the system is otherwise in good shape and leaks are minor and fixable.
...
1. **Check the outdoor unit nameplate.** This is the metal data plate affixed to the side or back of your outdoor condenser. It lists the refrigerant type (e.g., "Refrigerant: R-410A") along with the charge weight in ounces or pounds.
2. **Check the indoor air handler.** There may be a sticker or data plate there as well, especially on newer units.
3. **Check your installation paperwork or manual.** The original spec sheet should list the refrigerant type.
4. **Look up your model number.** If the nameplate is faded, search the model number on the manufacturer's website. The spec page will list the refrigerant type.
5. **Check the service ports.** R-22 and R-410A have different sized service port fittings (R-410A fittings are larger to prevent accidental cross-charging). A technician can identify the refrigerant type immediately from the port size and pressure readings.
